...
module proc_kernel #(
    ...
    wire [                        8-1:0] store_depth;
    wire                                 store_mt_en;
    wire [                        5-1:0] pc_fp0_load_vec;
    wire [                        5-1:0] pc_fp1_load_vec;
    wire                                 pc_fp_updt_en;
    wire                                 pc_fp_updt_sel;
    wire [                        5-1:0] pc_fp_updt_vec;
    wire [                        5-1:0] pc_fp0_exec_vec;
    wire [                        5-1:0] pc_fp1_exec_vec;
    wire [                        3-1:0] pc_fp_op_sel;
    wire                                 psu_acc;
    wire                                 psu_clr;
    wire                                 loadx_tile_sel;
    wire                                 execx_tile_sel;
    ...
    pccmd_ctrl pccmd_ctrl_inst (
        ...
        .store_mt_en        (store_mt_en),
        .psu_acc            (psu_acc),
        .psu_clr            (psu_clr),
        .loadx_tile_sel     (loadx_tile_sel),
        .execx_tile_sel     (execx_tile_sel),
        .loady_tile_sel     (loady_tile_sel),
        .execy_tile_sel     (execy_tile_sel),
        .const_fp16_reg     (const_fp16_reg),
        .pc_fp0_load_vec    (pc_fp0_load_vec),
        .pc_fp1_load_vec    (pc_fp1_load_vec),
