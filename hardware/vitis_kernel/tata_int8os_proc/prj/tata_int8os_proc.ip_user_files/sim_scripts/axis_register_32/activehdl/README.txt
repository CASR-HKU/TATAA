...
#
# Generated by export_simulation on Tue May 21 17:18:12 HKT 2024
#
################################################################################
...
'-reset_run' switch to the './axis_register_32.sh' script.

./axis_register_32.sh -reset_run
...
./axis_register_32.sh -noclean_files

For more information on the script, please type './axis_register_32.sh -help'.
