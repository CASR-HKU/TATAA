...
#
# Generated by export_simulation on Tue May 21 17:17:41 HKT 2024
#
################################################################################
...
'-reset_run' switch to the './axis_register_256.sh' script.

./axis_register_256.sh -reset_run
...
./axis_register_256.sh -noclean_files

For more information on the script, please type './axis_register_256.sh -help'.
