    ...
    if args.quant:
        ...
        with torch.no_grad():
            for i, image in enumerate(image_list):
                ...
                output = model(image)
        print("Model close calibration...")
        model.model_close_calibrate()
        print("Model quant...")
        model.model_quant()

    print('Validating...')
    val_loss, val_prec1, val_prec5 = validate(args, val_loader, model, criterion, device)
...
def validate(args, val_loader, model, criterion, device):
    ...
    print("Validation Dataset Length: ", len(val_loader))
